...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `users` (`id`,`fullName`,`email`,`password`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new User(_tmpId,_tmpFullName,_tmpEmail,_tmpPassword,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object emailExists(final String email, final Continuation<? super Boolean> $completion) {
